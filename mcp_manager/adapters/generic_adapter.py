...
class GenericAdapter:
    ...
    async def _select_mode(self, page, model_name):
        ...
        try:
            ...
            combined_picker = page.locator(picker_selectors[0])
            for sel in picker_selectors[1:]:
                combined_picker = combined_picker.or_(page.locator(sel))
            try:
                ...
                combined_items = page.locator(item_selectors[0])
                for sel in item_selectors[1:]:
                    combined_items = combined_items.or_(page.locator(sel))
