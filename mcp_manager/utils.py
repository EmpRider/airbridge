...
def sanitize_surrogates(text: str) -> str:
    ...
    """
    # OPTIMIZATION: Use a fast-path try/except block to avoid expensive encode/decode
    # replacement operations on clean strings. This yields significant performance gains.
    try:
        text.encode("utf-8")
        return text
